...
class CYYSoCConfig extends Config(new WithNExtTopInterrupts(4) ++ new WithTimebase(BigInt(100000000)) ++ new WithNBigCores(1)  ++ new WithExtMemSize(0x80000000L) ++ new BaseFPGAConfig)